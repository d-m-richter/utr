...
class ProbenhalterKurz {
  private:
  G4LogicalVolume *World_Logical;
  G4LogicalVolume *ProbenhalterKurz_Logical;
  //G4Tubs *Zylinder_Solid;
  //G4Tubs *Hohlzylinder_Solid;
  //G4UnionSolid *ProbenhalterKurz_Solid;
  ...
  ProbenhalterKurz(G4LogicalVolume *world_Logical) {
    // dimensions of ProbenhalterKurz
    ...
    ProbenhalterKurz_Logical = gdmlWorld->GetLogicalVolume();

    // joining the two cylinders to form the ProbenhalterKurz
    //G4ThreeVector move(0.,0.,12.);
    //ProbenhalterKurz_Solid = new G4UnionSolid("ProbenhalterKurz_Solid", Hohlzylinder_Solid, Zylinder_Solid, 0, move);

    //ProbenhalterKurz_Logical = new G4LogicalVolume(ProbenhalterKurz_Solid, PLA, "ProbenhalterKurz_Logical", 0, 0, 0);
    
    ProbenhalterKurz_Logical->SetVisAttributes(new G4VisAttributes(grey));
  ...
  void Put(G4double x, G4double y, G4double z) {
    new G4PVPlacement(0, G4ThreeVector(x, y, z), ProbenhalterKurz_Logical,
                      "ProbenhalterKurz", World_Logical, false, 0);
  }
  ...
  void Put(G4double x, G4double y, G4double z, G4double angle_x,
    ...
    new G4PVPlacement(rot, G4ThreeVector(x, y, z), ProbenhalterKurz_Logical,
                      "ProbenhalterKurz", World_Logical, false, 0);
  }
};