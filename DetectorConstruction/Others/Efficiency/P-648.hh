...
class P648 {
  ...
  P648(G4LogicalVolume *world_Logical) {
    // dimensions of ProbenhalterLang
    lenght = 0.5 * 24.35 * mm; // Measured
    ...
    P648_Solid = new G4Tubs("P648_Solid", 0., radius, lenght, sphi, dphi);

    P648_Logical = new G4LogicalVolume(P648_Solid, brass, "P648_Logical", 0, 0, 0);
    
    P648_Logical->SetVisAttributes(new G4VisAttributes(grey));
  ...
  void Put(G4double x, G4double y, G4double z) {
    new G4PVPlacement(0, G4ThreeVector(x, y, z), P648_Logical,
                      "P648", World_Logical, false, 0);
  }
  ...
  void Put(G4double x, G4double y, G4double z, G4double angle_x,
    ...
    new G4PVPlacement(rot, G4ThreeVector(x, y, z), P648_Logical,
                      "P648", World_Logical, false, 0);
  }
};