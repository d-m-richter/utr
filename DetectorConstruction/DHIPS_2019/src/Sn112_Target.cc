...
Sn112_Target::Sn112_Target(G4LogicalVolume *World_Log) : World_Logical(World_Log) {}
...
void Sn112_Target::Construct(G4ThreeVector global_coordinates) {
  ...
  G4double container_inner_length = co59_I_thickness + al27_II_thickness + sn112_III_thickness + al27_IV_thickness + co59_V_thickness;
