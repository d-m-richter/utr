...
/*
 * Setup of the Sn112 + Sn120 NRF experiment from the 2020 spring DHIPS
 * campaign. The purpose of this experiment was to measure the relative
 * excitation strength of the 2^+_1 state of 112Sn and 120Sn in NRF.
...
#endif
  Sn112_120_Target Sn112_120_Target(World_Logical);
  Sn112_120_Target.Construct(rotation, G4ThreeVector(0., 0., 0.));
#endif
