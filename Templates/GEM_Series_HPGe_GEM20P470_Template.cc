...
///*
  ...
  alutop->Put(0., 0., distance_source_detector + 134. - (134 - {{end_cap_length_above_table}}) - 300. - 100. - 15./2., 0., 90. *deg, 0.);
  ...
  // Bleiblöcke 4. Reihe für Messwert Distanz = 187mm

  // Reihe oben
  NormBrick *normbrick_4o = new NormBrick(world_logical);
  normbrick_4o->Put(51.25, 122.5, distance_source_detector + 134. - (134 - {{end_cap_length_above_table}}) + 5. - 100. - 100. - 100. - 100./2., 90. *deg, 90. *deg, 90. *deg);

  ShortNormBrick *shortnormbrick_4o = new ShortNormBrick(world_logical);
  shortnormbrick_4o->Put(-100., 122.5, distance_source_detector + 134. - (134 - {{end_cap_length_above_table}}) + 5. - 100. - 100. - 100. - 100./2., 90. *deg, 90. *deg, 90. *deg);
  
  // Reihe links
  NormBrick *normbrick_4l = new NormBrick(world_logical);
  normbrick_4l->Put(122.5, -0.125, distance_source_detector + 134. - (134 - {{end_cap_length_above_table}}) + 5. - 100. - 100. - 100. - 100./2., 90. *deg, 0. *deg, 90. *deg);

  // Reihe unten
  NormBrick *normbrick_4u = new NormBrick(world_logical);
  normbrick_4u->Put(-51.25, -122.5, distance_source_detector + 134. - (134 - {{end_cap_length_above_table}}) + 5. - 100. - 100. - 100. - 100./2., 90. *deg, 90. *deg, 90. *deg);

  ShortNormBrick *shortnormbrick_4u = new ShortNormBrick(world_logical);
  shortnormbrick_4u->Put(100., -122.5, distance_source_detector + 134. - (134 - {{end_cap_length_above_table}}) + 5. - 100. - 100. - 100. - 100./2., 90. *deg, 90. *deg, 90. *deg);

  // Reihe rechts
  NormBrick *normbrick_4r = new NormBrick(world_logical);
  normbrick_4r->Put(-122.5, 0.625, distance_source_detector + 134. - (134 - {{end_cap_length_above_table}}) + 5. - 100. - 100. - 100. - 100./2., 90. *deg, 0. *deg, 90. *deg);
//*/
