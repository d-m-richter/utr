...
class Petrischale {
  ...
  Petrischale(G4LogicalVolume *world_Logical) {
    ...
    if (currentPathString == "/nfs/ldas02/zh02/home/drichter/utr") {
      gdmlFileName = "../utr/DetectorConstruction/Others/Efficiency/Volumes/{{path_to_Petrischale_außen}}"; //"../utr/DetectorConstruction/Others/Efficiency/Volumes/Petrischale.gdml";
    }
    //else if (currentPathString == "/home/drichter/HOME/local/utr-radiationprotection/build") {
      ...
      gdmlFileName =  "../DetectorConstruction/Others/Efficiency/Volumes/{{path_to_Petrischale_außen}}"; //"../DetectorConstruction/Others/Efficiency/Volumes/Petrischale.gdml";
    } 
...
class Fuelvolumen {
  ...
  Fuelvolumen(G4LogicalVolume *world_Logical) {
    ...
    G4double density_fe = (204.8 / 71125.658) * g/mm3; // Schüttdichte
    ...
    G4double density_kappasorbwater = (74.2 / 71125.658) * g/mm3; // Schüttdichte
    G4Material *KappasorbWater = new G4Material("KappasorbWater", density_kappasorbwater, 2);
    G4double waterFraction = ((74.2 - 1.6) / 74.2); // In der Petrischale sind 72.6 g Wasser
    G4double kappaFraction = (1.6 / 74.2); // In der Petrischale sind 1.6 g Kappasorb
    ...
    //if (currentPathString == "/home/drichter/HOME/local/utr-radiationprotection") {
    if (currentPathString == "/nfs/ldas02/zh02/home/drichter/utr") {
      gdmlFileName =  "../utr/DetectorConstruction/Others/Efficiency/Volumes/{{path_to_Petrischale_Füllvolumen}}"; //"../utr/DetectorConstruction/Others/Efficiency/Volumes/Petrischale_Fuellvolumen.gdml";
    }
    //else if (currentPathString == "/home/drichter/HOME/local/utr-radiationprotection/build") {
    else if (currentPathString == "/nfs/ldas02/zh02/home/drichter/utr/build") {
      gdmlFileName =  "../DetectorConstruction/Others/Efficiency/Volumes/{{path_to_Petrischale_Füllvolumen}}"; //"../DetectorConstruction/Others/Efficiency/Volumes/Petrischale_Fuellvolumen.gdml";
    } 
