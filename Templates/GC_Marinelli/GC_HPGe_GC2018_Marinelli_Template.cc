...
//  const double filter_thickness = 0.5 * mm;           // <------ adjust filter thickness
 ...
 //     HPGe_GC2018_props.end_cap_to_crystal_gap_front; // Calculated from end cap length
  ...
  Becher_Halterung *becherhalterung = new Becher_Halterung(world_logical);
  becherhalterung->Put(0., 0., 93.875, 180 * deg, 0., 0.);

  /***************** Marinelli Becher *********************************/

  Marinelli_Beaker *marinellibecher = new Marinelli_Beaker(world_logical);
  marinellibecher->Put(0., 0., 93.875 - 31.2, 180 * deg, 0., 0.);

  Marinelli_Beaker_Filled *marinellibecherfilled = new Marinelli_Beaker_Filled(world_logical);
  marinellibecherfilled->Put(0., 0., 93.875 - 31.2 - 1.5, 180 * deg, 0., 0.);
