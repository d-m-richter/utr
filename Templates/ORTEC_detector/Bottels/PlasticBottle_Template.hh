...
class Plastic_Bottle {
  ...
  Plastic_Bottle(G4LogicalVolume *world_Logical) {
    ...
    if (currentPathString == "/nfs/ldas02/zh02/home/drichter/utr") {
      gdmlFileName = "DetectorConstruction/Others/Efficiency/Volumes/Outer_Bottle.gdml";
    }
...
class Plastic_Bottle_Filled {
  ...
  Plastic_Bottle_Filled(G4LogicalVolume *world_Logical) {
    ...
    G4double density = 0.768 *g/cm3; //(1689.01 / 2198) * g/cm3; // 0.76 * g/cm3;
    G4NistManager* man = G4NistManager::Instance();
    G4Material* AlO = man->FindOrBuildMaterial("G4_ALUMINUM_OXIDE");
    //G4Material* material = man->FindOrBuildMaterial({{material}});
    //G4Material* material = man->FindOrBuildMaterial("G4_Si");
    G4Material* AlO_new = man->BuildMaterialWithNewDensity("G4_ALUMINIUM_OXIDE_new","G4_ALUMINUM_OXIDE",density);
    ...
    std::string currentPathString = currentPath.string();
    if (currentPathString == "/nfs/ldas02/zh02/home/drichter/utr") {
      gdmlFileName = "DetectorConstruction/Others/Efficiency/Volumes/Inner_Bottle.gdml";
    }
    else if (currentPathString == "/nfs/ldas02/zh02/home/drichter/utr/build") {
      gdmlFileName = "../DetectorConstruction/Others/Efficiency/Volumes/Inner_Bottle.gdml";
    } 
    ...
    //PlasticBottleFilled_Logical->SetMaterial(material);
...
class Bottle_Holder {
  ...
  Bottle_Holder(G4LogicalVolume *world_Logical) {
    ...
    std::string currentPathString = currentPath.string();
    if (currentPathString == "/nfs/ldas02/zh02/home/drichter/utr") {
      gdmlFileName = "DetectorConstruction/Others/Efficiency/Volumes/Bottle_Holder.gdml";
    }
    else if (currentPathString == "/nfs/ldas02/zh02/home/drichter/utr/build") {
      gdmlFileName = "../DetectorConstruction/Others/Efficiency/Volumes/Bottle_Holder.gdml";
    } 
