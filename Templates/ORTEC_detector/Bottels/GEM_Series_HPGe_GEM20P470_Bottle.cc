...
//  const double filter_thickness = 0.5 * mm;           // <------ adjust filter thickness
 ...
 // G4Material *PLA = nist->FindOrBuildMaterial("G4_PLA");
  ...
  HPGe_GEM20P470_props.detector_radius = 0.5 * 50 * mm; // 0.5 * 50 mm
  HPGe_GEM20P470_props.detector_length = 64 * mm; // 64 mm 
  ...
  HPGe_GEM20P470_props.hole_radius = 0.5 * 9.6 * mm; // 9.6 * mm; 
  HPGe_GEM20P470_props.hole_depth = 51.5 * mm; // 51.5 * mm;
  HPGe_GEM20P470_props.hole_face_radius = 5. * mm; // {{hole_face_radius}} // 5. * mm
  HPGe_GEM20P470_props.dead_layer_side = 0.5 * mm; // 0.7 * mm Ge/Li --> is ok to use Ge density
  HPGe_GEM20P470_props.dead_layer_top = 0.5 * mm; // 0.7 * mm Ge/Li --> is ok to use Ge density
 ...
 //     HPGe_GEM20P470_props.end_cap_to_crystal_gap_front; // Calculated from end cap length
  ...
  plasticbottle->Put(0., 0., -10, 180 * deg, 0., 0.); // -3.5

  Plastic_Bottle_Filled *plasticbottlefilled = new Plastic_Bottle_Filled(world_logical);
  plasticbottlefilled->Put(0., 0., -11.25, 180 * deg, 0., 0.); // -4.75
...
/*
  ...
  alubottom_withhole->Put(0., 0., distance_source_detector + 133.5 - 5./2., 0., 0., 0.);
