...
// Input for Strahlrohr
#include "Strahlrohr.hh"
...
//  const double filter_thickness = 0.5 * mm;           // <------ adjust filter thickness
 ...
 //     HPGe_GC2018_props.end_cap_to_crystal_gap_front; // Calculated from end cap length
  ...
  /***************** Edelstahl Strahlrohr *********************************/

  Edelstahl_Strahlrohr *edelstahlstrahlrohr = new Edelstahl_Strahlrohr(world_logical);
  edelstahlstrahlrohr->Put(0., 0., 0., 180 * deg, 0., 0.);

  /***************** Folienhalter ************************************************/
  ///*
  G4double folienhalterung_position = 93.875 - 100. *mm; 
  ...
  /***************** Plastikstück ************************************************/
  /*
  G4double Plastik_position = 93.875 - 130.0 - 6.5 -(0.5 * 0.6);

  G4Tubs *Plastik_solid = new G4Tubs("Plastik_Solid", 0 *mm, 0.5 * 100.0 *mm, 0.5 * 0.6 *mm, 0. *deg, 360. *deg);
  G4LogicalVolume *Plastik_logical = new G4LogicalVolume(Plastik_solid, polyethylene, "Plastik_Logical");
  ...
  G4PVPlacement *Plastik_phys = new G4PVPlacement(0, G4ThreeVector(0, 0, Plastik_position), Plastik_logical, "Plastik", world_logical, false, 0);
  */
...
///*
  ...
  G4PVPlacement *hohlzylinder_phys = new G4PVPlacement(0, G4ThreeVector(0, 0, 93.875 - 100./2.), hohlzylinder_logical, "Hohlzylinder", world_logical, false, 0);
//*/
