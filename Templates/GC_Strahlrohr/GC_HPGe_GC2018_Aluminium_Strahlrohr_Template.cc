...
//  const double filter_thickness = 0.5 * mm;           // <------ adjust filter thickness
 ...
 //     HPGe_GC2018_props.end_cap_to_crystal_gap_front; // Calculated from end cap length
  ...
  /***************** Aluminium Strahlrohr *********************************/

  Aluminium_Strahlrohr *aluminiumstrahlrohr = new Aluminium_Strahlrohr(world_logical);
  aluminiumstrahlrohr->Put(0., 0., 93.875 - 130. - 6.5 - 0.6, 180 * deg, 0., 0.);

  /***************** Folienhalter ************************************************/
  ///*
  G4double folienhalterung_position = 93.875 - 130. *mm; 
...
///*
  G4Tubs *hohlzylinder_solid = new G4Tubs("Hohlzylinder_Solid", 0.5 * 81.0 *mm, 0.5 * 102.0 *mm, 0.5 * 130.0 *mm, 0. *deg, 360. *deg); // für die Simulation mit mehreren Petrischalen wurde 117.5 mm für den Durchmesser verwendet
  ...
  G4PVPlacement *hohlzylinder_phys = new G4PVPlacement(0, G4ThreeVector(0, 0, 93.875 - 130./2.), hohlzylinder_logical, "Hohlzylinder", world_logical, false, 0);
//*/
